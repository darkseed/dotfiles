...
" Handle trailing whitespace, shamelessly taken from
...
if &term == "screen-256color"
  seet t_fs= t_tf &term == "screen-256color" || &term == "screen" || &term == "xterm"
  set title
endif
...
"if filereadable(expand("/usr/local/lib/python2.7/site-packages/powerline/bindings/vim/plugin/powerline.vim"))
